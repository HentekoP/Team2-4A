...
namespace Project.Scripts.Breaks //参照しやすいようにしている
{
    ...
    {
        public HashSet<ChunkNode> Neighbours = new HashSet<ChunkNode>();    //HashSetで配列の要素が重複しないようにしている
        public ChunkNode[] NeighboursArray = new ChunkNode[0];
        private Dictionary<Joint, ChunkNode> JointToChunk = new Dictionary<Joint, ChunkNode>(); //Dictionaryは番号ではなく名前で要素を検索できる　Dictionary<名前, 配列>
        ...
        {
            return Neighbours.Contains(chunkNode);  //Containsは要素の検索
        }
